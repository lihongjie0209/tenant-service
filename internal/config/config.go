...
func setDefaults(v *viper.Viper) {
	v.SetDefault("app.name", "tenant-service")
	...
	v.SetDefault("database.schema", "tenant")
	...
	v.SetDefault("jwt.issuer", "tenant-service")
	...
	v.SetDefault("auth.audience", "tenant-service")
	...
	v.SetDefault("migration.table", "tenant_schema_migrations")
