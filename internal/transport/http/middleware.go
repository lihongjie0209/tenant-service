...
func tenantHTTPRequirement(route string) (platformauthz.Requirement, bool) {
	requirements := map[string]platformauthz.Requirement{
		...
		"/api/v1/organization-units/create": {Resource: "tenant.organization-unit", Action: "create", Scope: platformauthz.ScopePrincipal}, "/api/v1/organization-units/get": {Resource: "tenant.organization-unit", Action: "read", Scope: platformauthz.ScopePrincipal}, "/api/v1/organization-units/batch-get": {Resource: "tenant.organization-unit", Action: "read", Scope: platformauthz.ScopePrincipal}, "/api/v1/organization-units/update": {Resource: "tenant.organization-unit", Action: "update", Scope: platformauthz.ScopePrincipal}, "/api/v1/organization-units/list": {Resource: "tenant.organization-unit", Action: "list", Scope: platformauthz.ScopePrincipal}, "/api/v1/organization-units/tree": {Resource: "tenant.organization-unit", Action: "list", Scope: platformauthz.ScopePrincipal},
		"/api/v1/invitations/create": {Resource: "tenant.invitation", Action: "create", Scope: platformauthz.ScopePrincipal}, "/api/v1/invitations/get": {Resource: "tenant.invitation", Action: "read", Scope: platformauthz.ScopePrincipal}, "/api/v1/invitations/revoke": {Resource: "tenant.invitation", Action: "revoke", Scope: platformauthz.ScopePrincipal}, "/api/v1/invitations/list": {Resource: "tenant.invitation", Action: "list", Scope: platformauthz.ScopePrincipal},
		"/api/v1/groups/create": {Resource: "tenant.group", Action: "create", Scope: platformauthz.ScopePrincipal}, "/api/v1/groups/update": {Resource: "tenant.group", Action: "update", Scope: platformauthz.ScopePrincipal}, "/api/v1/groups/member-add": {Resource: "tenant.group", Action: "add-member", Scope: platformauthz.ScopePrincipal}, "/api/v1/groups/member-remove": {Resource: "tenant.group", Action: "remove-member", Scope: platformauthz.ScopePrincipal}, "/api/v1/groups/members/get": {Resource: "tenant.group", Action: "read-member", Scope: platformauthz.ScopePrincipal}, "/api/v1/groups/members/list": {Resource: "tenant.group", Action: "list-members", Scope: platformauthz.ScopePrincipal}, "/api/v1/groups/members/batch-get": {Resource: "tenant.group", Action: "list-members", Scope: platformauthz.ScopePrincipal}, "/api/v1/groups/list": {Resource: "tenant.group", Action: "list", Scope: platformauthz.ScopePrincipal}, "/api/v1/groups/search": {Resource: "tenant.group", Action: "list", Scope: platformauthz.ScopePrincipal},
