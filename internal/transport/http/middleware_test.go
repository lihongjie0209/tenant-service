...
func TestTenantHTTPRequirementCoverageAndSelfServiceExclusions(t *testing.T) {
	t.Parallel()
	protected := []string{
		"/api/v1/tenants/manage/create", "/api/v1/tenants/get", "/api/v1/tenants/update", "/api/v1/tenants/list", "/api/v1/memberships/add", "/api/v1/memberships/get", "/api/v1/memberships/update", "/api/v1/memberships/list",
		...
		"/api/v1/invitations/create", "/api/v1/invitations/get", "/api/v1/invitations/revoke", "/api/v1/invitations/list", "/api/v1/groups/create", "/api/v1/groups/get", "/api/v1/groups/update", "/api/v1/groups/member-add", "/api/v1/groups/member-remove", "/api/v1/groups/members/get", "/api/v1/groups/members/list", "/api/v1/groups/list",
